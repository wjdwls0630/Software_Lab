...
int main() {
    ...
    double V = 48.0; // voltage source : 48 V
    double L = 100e-3;  // inductance: 100mH
    double C = 0.4e-6;  // capacitance: 0.4uF
    double R = 280.0;  // resistance: 280ohm

    //initialize variables
    double vt_dt_plus = 0, vt = 0, vt_dt_minus = 0;
    double start_time = 0; //start time
    double end_time = 6e-3; // end time 6ms
