                ...
                dev.m_queue.submit([&](cl::sycl::handler &cgh) {
                    ...
                    cgh.parallel_for<PlaceHolderExpr>(
                            ...
                            [=](cl::sycl::nd_item<1> itemID) {
                                ...
                                auto device_expr = TensorSycl::internal::createDeviceExpression<DevExpr, PlaceHolderExpr>(
                                ...
                                if (globalid < rng)
                                    tmp_global_accessor.get_pointer()[globalid] = InnerMostDimReducer<decltype(device_self_evaluator), Op, false>::reduce(
