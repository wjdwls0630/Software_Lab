...
'teststring', '"Do nine men interpret?" "Nine men," I nod.')
...
'test3dmatrix', reshape(1:24,[2 3 4]))
...
';
fclose(fid);
save_matfile('testunicode',
native2unicode(from_japan,
'utf-8'));
end
